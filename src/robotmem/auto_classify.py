...
def classify_category(text: str) -> str:
    ...
    return tags[0] if tags else "code"
...
def normalize_scope_files(
    files: list[str], project_root: str | None = None,
) -> list[str]:
